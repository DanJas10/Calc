...
<body>
    ...
    <div class="bg-info mx-auto text-center text-black" style="width: 24rem;">DAN JAS J(212223040028)</div>
...
```
## OUTPUT:
![Screenshot 2024-04-28 225111](https://github.com/DanJas10/Calc/assets/150931233/6dab4ac7-4765-4895-bccf-a98930e2f16d)
